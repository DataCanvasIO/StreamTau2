...
@Getter
public class FailGetUnaryEvaluator extends RuntimeException {
    private static final long serialVersionUID = -6578147135348775170L;

    private final UnaryEvaluatorFactory factory;
    private final Class<?> paraType;
}
