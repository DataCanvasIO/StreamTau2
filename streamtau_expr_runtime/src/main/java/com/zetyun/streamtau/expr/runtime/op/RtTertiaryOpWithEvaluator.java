...
public class RtTertiaryOpWithEvaluator extends RtTertiaryOp {
    private static final long serialVersionUID = -4277159169097503270L;

    @Nonnull
    private final TertiaryEvaluator evaluator;

    public RtTertiaryOpWithEvaluator(
        @Nonnull TertiaryEvaluator evaluator,
        @Nonnull RtExpr para0,
        @Nonnull RtExpr para1,
        @Nonnull RtExpr para2
    ) {
        super(para0, para1, para2);
