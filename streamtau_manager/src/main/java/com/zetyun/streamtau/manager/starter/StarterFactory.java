...
import com.zetyun.streamtau.manager.runner.CmdLineRunner;
import com.zetyun.streamtau.manager.runner.JavaJarRunner;
import com.zetyun.streamtau.manager.runner.Runner;
...
public class StarterFactory {
    private static StarterFactory INS;
    ...
    public static StarterFactory get() {
        if (INS == null) {
            INS = new StarterFactory();
        }
        return INS;
    }
